  ...
  <header>
    <div class="container-fluid">
      <table class="table-condensed login pull-right">
        <tr>
         <td>
           <g:link controller="Cliente" action="login"><button type="button" class="btn btn-outline-primary btn-lg">Entrar</button></g:link>
         </td>
         <td>
           <g:link controller="Cliente" action="cadastro"><button type="button" class="btn btn-outline-primary btn-lg">Cadastrar-se</button></g:link>
         </td>
       </tr>
     </table>
   </div>
   ...
   <nav id="meuMenu">
     ...
     <td>
      <g:link controller="#">Contato</g:link>
    </td>
    <td>
      <g:link controller="#">Avaliações</g:link>
    </td>
    <td>
      <g:link controller="#">Fotos</g:link>
    </td>
...
<footer>
  <div class="container centered ptb">
    <div class="col-md-6 col-md-offset-3">
      ...
      <div class="credits">
        <span class="branco">Criado com template Polaroyd feito por <a href="https://templatemag.com/"></span>TemplateMag</a>
      </div>
    </div>
  </div>
...
<asset:javascript src="interatividade.js"/>
